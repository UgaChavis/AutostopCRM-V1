...
| 003 | P1 | [Разрезать монолитные test modules и fixtures](003-split-test-suites.md) | **Attachment-read slice опубликован; shared-file-read test slice локально проверен** | 001 |
...
| 008 | P1 | [Разрезать MCP tool registration по доменам](008-split-mcp-tool-registration.md) | **Attachment-read registrar опубликован; shared-file-read registrar локально проверен** | 001; свой test-slice из 003 |
