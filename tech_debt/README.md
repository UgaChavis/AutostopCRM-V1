...
009, 012, 013, 014, 018, 019, 021 и 206.

Этап 2 не входит в текущую очередь: новая архитектурная инициатива требует
отдельного owner-approved ADR; 206 — только после решения о runtime, а его
attestation scope — только при доказанной боли после 009.
