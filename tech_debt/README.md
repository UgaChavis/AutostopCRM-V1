...
| 003 | P1 | [Разрезать монолитные test modules и fixtures](003-split-test-suites.md) | **Read baseline опубликован; column/sticky write tests локально готовы** | 001 |
...
| 008 | P1 | [Разрезать MCP tool registration по доменам](008-split-mcp-tool-registration.md) | **Column/sticky writes локально готовы; timer — следующий малый срез** | 001; свой test-slice из 003 |
