...
| 003 | P1 | [Разрезать монолитные test modules и fixtures](003-split-test-suites.md) | **Registration/payload/diagnostics опубликованы; board-read tests готовы локально** | 001 |
...
| 008 | P1 | [Разрезать MCP tool registration по доменам](008-split-mcp-tool-registration.md) | **Core board reads готовы локально; следующий write-срез сначала согласовать** | 001; свой test-slice из 003 |
