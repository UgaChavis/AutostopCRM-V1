...
| 003 | P1 | [Разрезать монолитные test modules и fixtures](003-split-test-suites.md) | **MCP read/board-write slices опубликованы; attachment-read test slice локально проверен** | 001 |
...
| 008 | P1 | [Разрезать MCP tool registration по доменам](008-split-mcp-tool-registration.md) | **Read/board-write registrars опубликованы; attachment-read registrar локально проверен** | 001; свой test-slice из 003 |
