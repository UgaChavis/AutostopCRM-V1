...
| `search_clients` | read | Ищет клиента по ФИО, части ФИО, названию организации, телефону, email, ИНН, реквизитам, контактному лицу, автомобилю, госномеру или VIN из связанных карточек. |
