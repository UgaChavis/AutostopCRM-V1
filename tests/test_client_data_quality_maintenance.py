...
def load_client_data_quality_module() -> ModuleType:
    return load_module_from_file("client_data_quality_maintenance", SCRIPT_PATH)


class ClientDataQualityMaintenanceTests(unittest.TestCase):
    def test_loader_restores_previous_module_entry(self) -> None:
        module_name = "client_data_quality_maintenance"
        ...
        try:
            loaded_module = load_client_data_quality_module()
