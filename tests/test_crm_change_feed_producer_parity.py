...
class CrmChangeFeedProducerParityTests(unittest.TestCase):
    ...
    def test_all_write_routes_have_handler_gateway_producer_and_test_evidence(self) -> None:
        ...
        self.assertEqual(97, result["summary"]["write_actions"])
        self.assertEqual(73, result["summary"]["executor_contract_only"])
        self.assertEqual(73, result["summary"]["executor_contract_resolved"])
