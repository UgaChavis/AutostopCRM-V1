...
from tests.gateway_v2_read_contracts import GatewayV2ReadContractTestsMixin
...
class FakeBoardApi:
    ...
    def run_manager_operation(
        ...
        *,
        ...
        del limit
        self.manager_operations.append(
            {"operation": operation, "payload": dict(payload or {}), "actor_name": actor_name}
        )
        return {
            "ok": True,
            "data": {
...
class AgentGatewayV2Tests(
    ...
    def test_store_quote_note_readback_is_exact(self) -> None:
        result = {
            "ok": True,
            "verification": {"passed": True},
    ...
    async def test_raw_write_uses_ledger_and_deduplicates_only_completed_result(self) -> None:
        ...
        self.assertNotIn(OAUTH_AUDIT_ACTOR_HEADER, board_api.raw_requests[0]["extra_headers"])
        self.assertNotIn(OAUTH_AUDIT_ASSERTION_HEADER, board_api.raw_requests[0]["extra_headers"])
    ...
    async def test_named_board_dry_run_is_recorded_and_reported_without_parent_ledger(self) -> None:
        ...
        self.assertEqual(state["start_arguments"]["actor"], "CODEX")
        self.assertEqual(board_api.manager_operations[-1]["actor_name"], "CODEX")
        self.assertEqual(board_api.manager_operations[-1]["payload"]["actor_name"], "CODEX")
