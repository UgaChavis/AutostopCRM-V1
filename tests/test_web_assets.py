...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_ai_ui_exposes_new_entry_surface_and_legacy_fallback(self) -> None:
        ...
        self.assertIn("ai_relevant_facts: aiRelevantFacts", BOARD_WEB_APP_HTML)
        self.assertIn("work_summary: workSummary", BOARD_WEB_APP_HTML)
        self.assertIn("material_summary: materialSummary", BOARD_WEB_APP_HTML)
        self.assertIn("notes_summary: [reason, comment, note].filter(Boolean)", BOARD_WEB_APP_HTML)
