...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_agent_ui_exposes_board_and_card_entry_points_with_contextual_modal(self) -> None:
        ...
        self.assertIn('id="agentQuickActions"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTasksOpenButton"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillButton"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillPromptToggle"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillPromptPanel"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillPromptInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillPromptSaveButton"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentAutofillStatus"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTasksList"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTaskNameInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTaskPromptInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTaskScopeTypeInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTaskScheduleTypeInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentTaskInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentRunsDetails"', BOARD_WEB_APP_HTML)
        self.assertIn('id="agentRunsList"', BOARD_WEB_APP_HTML)
        ...
        self.assertIn("{ label: 'VIN', template: 'vin', prompt: 'Расшифруй VIN этой карточки, используй внешний VIN-декодер", BOARD_WEB_APP_HTML)
        self.assertIn("data-agent-template", BOARD_WEB_APP_HTML)
        self.assertIn("{ label: 'ПОРЯДОК', template: 'cleanup', prompt: 'Наведи порядок в этой карточке:", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function renderAgentRuns(runs)", BOARD_WEB_APP_HTML)
        self.assertIn("const active = items.find((item) => {", BOARD_WEB_APP_HTML)
        self.assertNotIn("return items[0];", BOARD_WEB_APP_HTML)
        self.assertNotIn("label: 'ЗАДАЧИ', action: 'tasks'", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("async function resetAgentAutofillPrompt()", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function mapAgentActionToConsoleEntry(action)", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function bindAgentUiEvents()", BOARD_WEB_APP_HTML)
        self.assertIn("function bindAgentTasksUiEvents()", BOARD_WEB_APP_HTML)
        self.assertIn("ensureAgentUi();", BOARD_WEB_APP_HTML)
        ...
        self.assertIn(".dialog--agent-tasks {", BOARD_WEB_APP_HTML)
        self.assertIn(".agent-tasks-launch {", BOARD_WEB_APP_HTML)
        self.assertIn(".agent-tasks-toolbar {", BOARD_WEB_APP_HTML)
        self.assertIn(".agent-task-row__prompt {", BOARD_WEB_APP_HTML)
    ...
    def test_employees_module_is_exposed_in_topbar_and_repair_order_rows(self) -> None:
        ...
        self.assertNotIn('id="employeesList"', BOARD_WEB_APP_HTML)
        ...
        self.assertIn(".employees-form-grid { grid-template-columns: repeat(6, minmax(0, 1fr)); }", BOARD_WEB_APP_HTML)
