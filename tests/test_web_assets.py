...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_operator_admin_exposes_dense_activity_journal(self) -> None:
        self.assertIn('id="operatorAdminTabs"', BOARD_WEB_APP_HTML)
        self.assertIn('data-operator-admin-tab="journal"', BOARD_WEB_APP_HTML)
        self.assertIn('data-operator-admin-tab="users"', BOARD_WEB_APP_HTML)
        self.assertIn('id="operatorAdminJournalPanel"', BOARD_WEB_APP_HTML)
        ...
        self.assertIn("data-operator-activity-table", BOARD_WEB_APP_HTML)
        ...
        self.assertIn('<select id="operatorActivityActionFilter"', BOARD_WEB_APP_HTML)
        self.assertNotIn('placeholder="card_opened"', BOARD_WEB_APP_HTML)
        self.assertIn("Авто, клиент, ЗН, файл", BOARD_WEB_APP_HTML)
        self.assertIn("operatorActivityDebounceTimer", BOARD_WEB_APP_HTML)
        self.assertIn("window.matchMedia('(max-width: 700px)')", BOARD_WEB_APP_HTML)
        self.assertIn(".operator-activity-scroll", BOARD_WEB_APP_HTML)
        self.assertIn(".operator-activity-scroll.is-overflowing::after", BOARD_WEB_APP_HTML)
        self.assertIn("Сдвиньте вправо", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("'/api/get_operator_activity_details", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function openOperatorActivityDetails", BOARD_WEB_APP_HTML)
        self.assertIn("function operatorActivityDetailLabel", BOARD_WEB_APP_HTML)
        self.assertIn("ID события", BOARD_WEB_APP_HTML)
        self.assertIn("Архив деталей", BOARD_WEB_APP_HTML)
        self.assertIn("tabName: 'users'", BOARD_WEB_APP_HTML)
        self.assertIn('id="operatorActivityDetailsPanel"', BOARD_WEB_APP_HTML)
        self.assertIn("operatorActivityCell(row.object_label || '-'", BOARD_WEB_APP_HTML)
        self.assertNotIn("operatorActivityCell(row.object_id", BOARD_WEB_APP_HTML)
        self.assertNotIn("operatorActivityCell(row.details_ref", BOARD_WEB_APP_HTML)
    ...
    def test_topbar_repair_orders_list_uses_compact_row_open_flow(self) -> None:
        ...
        persist_fragment = BOARD_WEB_APP_HTML[
            ...
            ) : BOARD_WEB_APP_HTML.index("async function autofillRepairOrder")
        ]
