...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_repair_order_modal_exposes_minimal_form_and_print_flow(self) -> None:
        ...
        self.assertIn("const taxes = repairOrderProjectedTaxesValue(subtotal, paymentMethod);", BOARD_WEB_APP_HTML)
        self.assertIn("const cashlessDue = repairOrderRoundMoney(grandTotal - prepayment);", BOARD_WEB_APP_HTML)
        self.assertIn("const cashDue = repairOrderRoundMoney(subtotal - prepayment);", BOARD_WEB_APP_HTML)
