...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_repair_order_modal_exposes_minimal_form_and_print_flow(self) -> None:
        ...
        self.assertIn("const cashPayments = repairOrderCashPaymentsValue(state.repairOrderPayments);", BOARD_WEB_APP_HTML)
        self.assertIn("const cashlessPayments = repairOrderCashlessPaymentsValue(state.repairOrderPayments);", BOARD_WEB_APP_HTML)
        self.assertIn("const cashlessDue = repairOrderRoundMoney(grandTotal - cashlessPayments);", BOARD_WEB_APP_HTML)
        self.assertIn("const cashDue = repairOrderRoundMoney(subtotal - cashPayments);", BOARD_WEB_APP_HTML)
