...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_ai_ui_exposes_new_entry_surface_and_legacy_fallback(self) -> None:
        ...
        self.assertIn("function aiChatBuildAssistantResponse(input)", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function handleAiChatWindowSend()", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("const response = aiChatBuildAssistantResponse(input);", BOARD_WEB_APP_HTML)
        self.assertIn("appendAiChatWindowMessage('assistant', response, { kind: 'scoped_runtime', source: 'ai_chat', topic: 'reply' });", BOARD_WEB_APP_HTML)
