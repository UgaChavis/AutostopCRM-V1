...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_ai_ui_exposes_new_entry_surface_and_legacy_fallback(self) -> None:
        ...
        self.assertIn('id="aiSurfaceTitle">AI / ПОМОЩНИК</div>', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiSurfaceContextLabel">РЕЖИМ: ОБЩИЙ ЧАТ</div>', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiSurfaceStatusLabel" data-state="idle">СКРЫТО</div>', BOARD_WEB_APP_HTML)
        ...
        self.assertIn('Выберите, что хотите сделать.', BOARD_WEB_APP_HTML)
        self.assertIn('Старое меню агента оставлено только как резервный путь', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindow"', BOARD_WEB_APP_HTML)
        self.assertIn('class="dialog dialog--agent dialog--ai-chat"', BOARD_WEB_APP_HTML)
        self.assertIn('ai-chat-window__layout', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowTitle">AI / ЧАТ</div>', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowContextLabel">КОНТЕКСТ: AI-ЧАТ · СВОБОДНАЯ СЕССИЯ</div>', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowSubtitle"', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowStatusLabel" data-state="idle">HIDDEN</div>', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowMessages"', BOARD_WEB_APP_HTML)
        self.assertIn('class="ai-chat-window__messages-pane" aria-label="История сообщений"', BOARD_WEB_APP_HTML)
        self.assertIn('role="log" aria-live="polite" aria-relevant="additions text" aria-atomic="false"', BOARD_WEB_APP_HTML)
        self.assertIn('aiChatWindowHistory: []', BOARD_WEB_APP_HTML)
        self.assertIn('aiCompactContext: { kind: \'compact_context\' }', BOARD_WEB_APP_HTML)
        self.assertIn("aiCompactContextCache: { signature: '', packet: null }", BOARD_WEB_APP_HTML)
        self.assertIn('aiChatWindowSettingsOpen: false', BOARD_WEB_APP_HTML)
        self.assertIn('aiChatWindowPromptProfile: {', BOARD_WEB_APP_HTML)
        self.assertIn("function createAiChatMessage(role, text, meta = {})", BOARD_WEB_APP_HTML)
        self.assertIn("function ensureAiChatWindowHistory()", BOARD_WEB_APP_HTML)
        self.assertIn("function ensureAiChatWindowPromptProfile()", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatContextCardLabel(card = state.activeCard)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatContextRepairOrderLabel(repairOrder = null)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatActiveRepairOrderScope()", BOARD_WEB_APP_HTML)
        self.assertIn("function aiSurfaceScenarioTitle(scenarioId, scenario)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiSurfaceScenarioDescription(scenarioId)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiSurfaceScenarioUserMeta(scenarioId)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiSurfacePrimaryPathSummary(primaryPath)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiSurfaceAvailableScenarioSummary(availableScenarioIds)", BOARD_WEB_APP_HTML)
        self.assertIn("return 'Чат с AI';", BOARD_WEB_APP_HTML)
        self.assertIn("return 'Обогатить карточку';", BOARD_WEB_APP_HTML)
        self.assertIn("return 'Фоновый контроль доски';", BOARD_WEB_APP_HTML)
        self.assertIn("function aiWallDigestShortText(source, fallback = '')", BOARD_WEB_APP_HTML)
        self.assertIn("const AI_COMPACT_CONTEXT_LIMITS = Object.freeze({", BOARD_WEB_APP_HTML)
        self.assertIn("function aiCompactTrimList(list, limit = 0)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiCompactTrimText(source, fallback = '', limit = 160)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiCompactPickFields(source, fields = [])", BOARD_WEB_APP_HTML)
        self.assertIn("function aiCompactContextPacketSignature(packet)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiScenarioContextPacket(scenarioId = 'ai_chat')", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiFullCardEnrichmentContextPacket()", BOARD_WEB_APP_HTML)
        self.assertIn("function aiWallDigestEventSummary(event)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiWallDigestCardSignal(card)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiWallDigestPacket(wall = state.gptWall)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiCardContextPacket(card = state.activeCard, repairOrder = null, wallDigest = null)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiRepairOrderContextPacket(repairOrder = null, card = state.activeCard, wallDigest = null)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiAttachmentIntakePacket(card = state.activeCard, repairOrder = aiChatActiveRepairOrderScope(), wallDigest = null)", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiCompactContextPacket()", BOARD_WEB_APP_HTML)
        self.assertIn("function buildAiChatWindowContext()", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatCompactContextSummary(context = state.aiCompactContext)", BOARD_WEB_APP_HTML)
        self.assertIn("function refreshAiCompactContextPacket()", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatKnowledgeSourceLabels(knowledge = state.aiChatWindowKnowledge)", BOARD_WEB_APP_HTML)
        self.assertIn("async function resolveAiChatKnowledge(input, context = state.aiCompactContext)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatRenderInlineMarkdown(source)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatRenderMarkdown(source)", BOARD_WEB_APP_HTML)
        self.assertIn("function aiChatRenderMessageBody(message)", BOARD_WEB_APP_HTML)
        self.assertIn("async function aiChatBuildAssistantResponse(input)", BOARD_WEB_APP_HTML)
        self.assertIn("function renderAiChatWindowHistory()", BOARD_WEB_APP_HTML)
        self.assertIn("function renderAiChatWindowContext()", BOARD_WEB_APP_HTML)
        self.assertIn("function appendAiChatWindowMessage(role, text, meta = {})", BOARD_WEB_APP_HTML)
        self.assertIn("function focusAiChatWindowInput()", BOARD_WEB_APP_HTML)
        ...
        self.assertIn('id="aiChatWindowSettingsPane"', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowPromptSystem"', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowPromptResponse"', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowPromptProfileInput"', BOARD_WEB_APP_HTML)
        self.assertIn('title="Профиль чата">НАСТРОЙКИ</button>', BOARD_WEB_APP_HTML)
        self.assertIn('.ai-chat-window__message-text code {', BOARD_WEB_APP_HTML)
        self.assertIn('.ai-chat-window__message-text pre {', BOARD_WEB_APP_HTML)
        self.assertIn('.ai-chat-window__message-text a {', BOARD_WEB_APP_HTML)
        self.assertIn('.ai-chat-window__message-text strong {', BOARD_WEB_APP_HTML)
        self.assertIn('.ai-chat-window__message-text em {', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowSettingsButton"', BOARD_WEB_APP_HTML)
        self.assertIn('id="aiChatWindowSendButton"', BOARD_WEB_APP_HTML)
        self.assertIn("els.aiChatWindowSettingsButton?.addEventListener('click', handleAiChatWindowSettingsToggle);", BOARD_WEB_APP_HTML)
        self.assertIn("els.aiChatWindowSendButton?.addEventListener('click', handleAiChatWindowSend);", BOARD_WEB_APP_HTML)
        self.assertIn("els.aiChatWindowInput?.addEventListener('keydown', handleAiChatWindowInputKeydown);", BOARD_WEB_APP_HTML)
        self.assertIn("els.aiChatWindowPromptProfileInput?.addEventListener('input', handleAiChatWindowPromptProfileInput);", BOARD_WEB_APP_HTML)
        self.assertIn("prompt_profile_kind: 'ai_chat'", BOARD_WEB_APP_HTML)
        self.assertIn("aiChatWindowKnowledge: null", BOARD_WEB_APP_HTML)
        self.assertIn("card_label: String(source.card_label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("repair_order_label: String(source.repair_order_label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("repair_order_context_label: String(source.repair_order_context_label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("context_label: String(source.context_label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("wall_digest_label: String(source.wall_digest?.summary_label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("wall_view: String(source.wall_context?.view || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_ready: Boolean(source.attachments_intake?.ready)", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_label: String(source.attachments_intake?.label || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_total_count: String(source.attachments_intake?.total_attachment_count ?? '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_card_ids: Array.isArray(source.attachments_intake?.card_attachment_ids) ? source.attachments_intake.card_attachment_ids.slice(0, 12) : []", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_repair_order_ids: Array.isArray(source.attachments_intake?.repair_order_attachment_ids) ? source.attachments_intake.repair_order_attachment_ids.slice(0, 12) : []", BOARD_WEB_APP_HTML)
        self.assertIn("summary_label: summaryLabel", BOARD_WEB_APP_HTML)
        self.assertIn("card_context: cardContext,", BOARD_WEB_APP_HTML)
        self.assertIn("summary_label: [cardShortId || cardId || 'CARD', cardVehicle, cardTitle].filter(Boolean).join(' · ')", BOARD_WEB_APP_HTML)
        self.assertIn("ai_relevant_facts: aiRelevantFacts", BOARD_WEB_APP_HTML)
        self.assertIn("vehicle_profile_compact: vehicleProfileCompact || (vehicleProfile && typeof vehicleProfile === 'object'", BOARD_WEB_APP_HTML)
        self.assertIn("? aiCompactPickFields(vehicleProfile, [", BOARD_WEB_APP_HTML)
        self.assertIn("wall_digest_summary: aiCompactTrimText(digest?.summary_text || '', digest?.summary_text || '', 360)", BOARD_WEB_APP_HTML)
        self.assertIn("wall_digest_key_facts: aiCompactTrimList(Array.isArray(digest?.key_facts) ? digest.key_facts : [], 4)", BOARD_WEB_APP_HTML)
        self.assertIn("wall_digest_notable_changes: aiCompactTrimList(Array.isArray(digest?.notable_changes) ? digest.notable_changes : [], 3)", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiChatWindowContext = buildAiChatWindowContext();", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiCompactContext = buildAiCompactContextPacket();", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiSurfaceContext = state.aiChatWindowContext;", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiChatWindowKnowledge = null;", BOARD_WEB_APP_HTML)
        self.assertIn("appendAiChatWindowMessage('user', input, { kind: 'user_input', source: 'composer' });", BOARD_WEB_APP_HTML)
        self.assertIn("const response = await aiChatBuildAssistantResponse(input);", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiChatWindowKnowledge = knowledge;", BOARD_WEB_APP_HTML)
        self.assertIn("appendAiChatWindowMessage('assistant', response, {", BOARD_WEB_APP_HTML)
        self.assertIn("knowledge_source_labels: aiChatKnowledgeSourceLabels()", BOARD_WEB_APP_HTML)
        self.assertIn("kind: 'error'", BOARD_WEB_APP_HTML)
        self.assertIn("focusAiChatWindowInput();", BOARD_WEB_APP_HTML)
        self.assertIn("'Источники: ' + sourceLabels.join(' · ')", BOARD_WEB_APP_HTML)
        self.assertIn("'Документы: ' + documentTitles.join(' · ')", BOARD_WEB_APP_HTML)
        self.assertIn("'Интернет: ' + internetTitles.join(' · ')", BOARD_WEB_APP_HTML)
        self.assertIn("knowledge?.documents?.used ? '- documents lookup used' : '- documents lookup skipped'", BOARD_WEB_APP_HTML)
        self.assertIn("knowledge?.internet?.used ? '- internet lookup used' : '- internet lookup skipped'", BOARD_WEB_APP_HTML)
        self.assertIn("context.card_context?.summary_label ? 'Карточка: ' + context.card_context.summary_label", BOARD_WEB_APP_HTML)
        self.assertIn("context.card_context?.ai_relevant_facts?.client ? 'Клиент: ' + context.card_context.ai_relevant_facts.client : ''", BOARD_WEB_APP_HTML)
        self.assertIn("context.card_context?.card_id ? '- card context available' : '- card context unavailable'", BOARD_WEB_APP_HTML)
        self.assertIn("packet.card_context?.summary_label || packet.card_label || 'AI-ЧАТ · СВОБОДНАЯ СЕССИЯ'", BOARD_WEB_APP_HTML)
        self.assertIn("kind: 'wall_digest'", BOARD_WEB_APP_HTML)
        self.assertIn("kind: 'repair_order_context'", BOARD_WEB_APP_HTML)
        self.assertIn("repair_order_context: repairOrderContext,", BOARD_WEB_APP_HTML)
        self.assertIn("repair_order_context_label: String(repairOrderContext?.summary_label || repairOrderLabel || '').trim()", BOARD_WEB_APP_HTML)
        self.assertIn("vehicle_id: vehicleId", BOARD_WEB_APP_HTML)
        self.assertIn("license_plate: licensePlate", BOARD_WEB_APP_HTML)
        self.assertIn("payment_summary: {", BOARD_WEB_APP_HTML)
        self.assertIn("ai_relevant_facts: aiRelevantFacts", BOARD_WEB_APP_HTML)
        self.assertIn("work_summary: aiCompactTrimList(workSummary, AI_COMPACT_CONTEXT_LIMITS.repair_work_summary)", BOARD_WEB_APP_HTML)
        self.assertIn("material_summary: aiCompactTrimList(materialSummary, AI_COMPACT_CONTEXT_LIMITS.repair_material_summary)", BOARD_WEB_APP_HTML)
        self.assertIn("notes_summary: aiCompactTrimList([reason, comment, note].filter(Boolean), 3)", BOARD_WEB_APP_HTML)
        self.assertIn("kind: 'attachments_intake'", BOARD_WEB_APP_HTML)
        self.assertIn("attachments_intake: attachmentsIntake,", BOARD_WEB_APP_HTML)
        self.assertIn("attachment_sources: {", BOARD_WEB_APP_HTML)
        self.assertIn("content_hint: contentHint || (aiReady ? 'AI-READY' : 'NOT READY')", BOARD_WEB_APP_HTML)
        self.assertIn("ai_ready: aiReady", BOARD_WEB_APP_HTML)
        self.assertIn("has_text_hint: Boolean(fileExtension && ['.txt', '.doc', '.docx', '.pdf'].includes(fileExtension.toLowerCase()) || String(fileName || '').toLowerCase().includes('scan') || String(fileName || '').toLowerCase().includes('photo'))", BOARD_WEB_APP_HTML)
        self.assertIn("knowledge_source_labels: Array.isArray(knowledge?.source_labels) ? knowledge.source_labels.slice(0, 6) : []", BOARD_WEB_APP_HTML)
        self.assertIn("if (Array.isArray(source.knowledge_source_labels)) {", BOARD_WEB_APP_HTML)
        self.assertIn("card_attachment_ids: aiCompactTrimList(normalizedItems.filter((item) => item.source_kind === 'card').map((item) => item.attachment_id).filter(Boolean), AI_COMPACT_CONTEXT_LIMITS.attachment_ids)", BOARD_WEB_APP_HTML)
        self.assertIn("repair_order_attachment_ids: aiCompactTrimList(normalizedItems.filter((item) => item.source_kind === 'repair_order').map((item) => item.attachment_id).filter(Boolean), AI_COMPACT_CONTEXT_LIMITS.attachment_ids)", BOARD_WEB_APP_HTML)
        self.assertIn("wall_digest: wallDigest,", BOARD_WEB_APP_HTML)
        self.assertIn("context.wall_digest?.label ? 'Контекст стены: ' + context.wall_digest.label : (context.wall_context?.label ? 'Контекст стены: ' + context.wall_context.label : '')", BOARD_WEB_APP_HTML)
        self.assertIn("context.wall_digest?.key_facts?.length ? 'Ключевые факты стены: ' + context.wall_digest.key_facts.slice(0, 3).join(' · ') : ''", BOARD_WEB_APP_HTML)
        self.assertIn("context.wall_digest?.has_wall ? '- wall digest available' : '- wall digest unavailable'", BOARD_WEB_APP_HTML)
        self.assertIn("context.attachments_intake?.items?.length ? 'Вложения AI: ' + context.attachments_intake.items.slice(0, 3).map((item) => item.file_name || item.content_hint || item.attachment_id || 'attachment').join(' · ') : ''", BOARD_WEB_APP_HTML)
        self.assertIn("context.attachments_intake?.items?.length ? '- attachment items available' : '- attachment items unavailable'", BOARD_WEB_APP_HTML)
        self.assertIn("context.repair_order_context?.summary_label ? 'Заказ-наряд: ' + context.repair_order_context.summary_label : (context.repair_order_label ? 'Заказ-наряд: ' + context.repair_order_label : 'Заказ-наряд: не привязан.')", BOARD_WEB_APP_HTML)
        self.assertIn("context.repair_order_context?.ai_relevant_facts?.payment_status_label ? 'Платежный статус: ' + context.repair_order_context.ai_relevant_facts.payment_status_label : ''", BOARD_WEB_APP_HTML)
        self.assertIn("context.repair_order_context?.repair_order_id ? '- repair order context available' : '- repair order context unavailable'", BOARD_WEB_APP_HTML)
        self.assertIn("state.aiSurfaceContext = state.aiChatWindowContext;", BOARD_WEB_APP_HTML)
        self.assertIn("scenario_id: 'full_card_enrichment'", BOARD_WEB_APP_HTML)
        self.assertIn("scenario_context: buildAiFullCardEnrichmentContextPacket()", BOARD_WEB_APP_HTML)
        self.assertIn("if (message?.context?.card_label) metaLine.push(escapeHtml(String(message.context.card_label)));", BOARD_WEB_APP_HTML)
        self.assertIn("if (message?.context?.repair_order_label) metaLine.push(escapeHtml(String(message.context.repair_order_label)));", BOARD_WEB_APP_HTML)
        self.assertIn("if (message?.context?.repair_order_context_label) metaLine.push(escapeHtml(String(message.context.repair_order_context_label)));", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function renderAiChatWindow(statusPayload)", BOARD_WEB_APP_HTML)
        self.assertIn("function openAiChatWindow()", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("ai-chat': () => closeAiChatWindow()", BOARD_WEB_APP_HTML)
        self.assertIn("els.aiChatWindow?.classList.contains('is-open')", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("els.cardAgentButton?.addEventListener('click', runFullCardEnrichment);", BOARD_WEB_APP_HTML)
        ...
        self.assertIn("function runFullCardEnrichment()", BOARD_WEB_APP_HTML)
        self.assertIn("function buildFullCardEnrichmentRequestPayload()", BOARD_WEB_APP_HTML)
        self.assertIn("function currentCardEnrichmentTask(tasks, options = {})", BOARD_WEB_APP_HTML)
        self.assertIn("function renderFullCardEnrichmentResult(statusPayload, scenario, selectedExposureLabel)", BOARD_WEB_APP_HTML)
        self.assertIn("function renderFullCardEnrichmentEntryState(statusPayload)", BOARD_WEB_APP_HTML)
        self.assertIn("function activeAiTaskContext()", BOARD_WEB_APP_HTML)
    ...
    def test_web_assets_do_not_keep_duplicate_active_function_names(self) -> None:
        ...
        self.assertIn('id="boardControlSettingsRow"', BOARD_WEB_APP_HTML)
        self.assertIn('id="boardControlToggle"', BOARD_WEB_APP_HTML)
        self.assertIn('id="boardControlIntervalInput"', BOARD_WEB_APP_HTML)
        self.assertIn('id="boardControlCooldownInput"', BOARD_WEB_APP_HTML)
        self.assertIn("function currentBoardControlSettings()", BOARD_WEB_APP_HTML)
        self.assertIn("function syncBoardControlSettingsForm()", BOARD_WEB_APP_HTML)
