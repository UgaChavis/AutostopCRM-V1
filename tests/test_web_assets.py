...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_employees_module_is_exposed_in_topbar_and_repair_order_rows(self) -> None:
        ...
        self.assertNotIn('id="employeesMeta"', BOARD_WEB_APP_HTML)
        self.assertNotIn('id="employeesReportMeta"', BOARD_WEB_APP_HTML)
        self.assertNotIn('id="employeeActiveInput"', BOARD_WEB_APP_HTML)
