...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_cashboxes_modal_exposes_minimal_accounting_workspace(self) -> None:
        ...
        self.assertIn(".card-journal-change__before", BOARD_WEB_APP_HTML)
        self.assertIn(".card-journal-entry.has-deletion", BOARD_WEB_APP_HTML)
    ...
    def test_modal_data_loader_helpers_drive_active_archive_and_gpt_paths(self) -> None:
        ...
        self.assertIn("function renderCardJournalChange(change)", BOARD_WEB_APP_HTML)
        self.assertIn("function renderCardJournalEntry(entry)", BOARD_WEB_APP_HTML)
        self.assertIn("entry.icon || actionEmoji(entry.action)", BOARD_WEB_APP_HTML)
        self.assertIn("normalizeCardJournalEntries(data)", BOARD_WEB_APP_HTML)
        self.assertIn("card-journal-change__before", BOARD_WEB_APP_HTML)
        self.assertIn("card-journal-change__after", BOARD_WEB_APP_HTML)
        self.assertIn("БЫЛО", BOARD_WEB_APP_HTML)
        self.assertIn("СТАЛО", BOARD_WEB_APP_HTML)
