...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_repair_order_modal_exposes_minimal_form_and_print_flow(self) -> None:
        ...
        self.assertIn('width: min(1360px, calc(100% - 18px));', BOARD_WEB_APP_HTML)
        ...
        self.assertIn('grid-template-columns: minmax(224px, 0.78fr) minmax(316px, 1fr) minmax(520px, 1.82fr);', BOARD_WEB_APP_HTML)
        ...
        self.assertIn('min-height: 138px;', BOARD_WEB_APP_HTML)
