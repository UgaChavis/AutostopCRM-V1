...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_repair_order_modal_exposes_minimal_form_and_print_flow(self) -> None:
        ...
        self.assertIn('id="repairOrderPrepayment"', BOARD_WEB_APP_HTML)
        ...
        self.assertIn("els.repairOrderPaymentMethod.value = normalized.payment_method;", BOARD_WEB_APP_HTML)
        self.assertIn("els.repairOrderPrepayment.value = normalized.prepayment;", BOARD_WEB_APP_HTML)
        self.assertIn("payment_method: els.repairOrderPaymentMethod.value,", BOARD_WEB_APP_HTML)
        self.assertIn("prepayment: els.repairOrderPrepayment.value,", BOARD_WEB_APP_HTML)
        self.assertIn('<section class="print-section"><h2>Информация для клиента</h2>', BOARD_WEB_APP_HTML)
        self.assertIn('Стоимость заказ-наряда', BOARD_WEB_APP_HTML)
        self.assertIn('Налоги и сборы', BOARD_WEB_APP_HTML)
        self.assertIn('Предоплата', BOARD_WEB_APP_HTML)
        self.assertIn('К доплате', BOARD_WEB_APP_HTML)
