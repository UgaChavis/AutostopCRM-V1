...
class WebAssetsTests(unittest.TestCase):
    ...
    def test_cashboxes_modal_exposes_minimal_accounting_workspace(self) -> None:
        ...
        self.assertIn('class="btn btn--accent" id="cashboxCreateButton">+ ДОБАВИТЬ КАССУ', BOARD_WEB_APP_HTML)
        self.assertIn('class="btn btn--ghost cashbox-delete-button" id="cashboxDeleteButton">УДАЛИТЬ КАССУ', BOARD_WEB_APP_HTML)
