...
class ConnectionCardTests(unittest.TestCase):
    ...
    def test_chatgpt_connect_payload_contains_key_values(self) -> None:
        ...
        self.assertIn("[OPTIONAL AUTOSTOPMANAGER TOOLS]", text)
        self.assertIn("- agent_brief", text)
        self.assertIn("- system_audit", text)
        self.assertIn("- list_manager_runs", text)
    ...
    def test_connector_and_responses_payloads_are_built_from_live_settings(self) -> None:
        ...
        self.assertEqual(len(MCP_TOOL_NAMES), 92)
        ...
        self.assertIn("list_shared_files", MCP_TOOL_NAMES)
        self.assertIn("get_shared_file_info", MCP_TOOL_NAMES)
        self.assertIn("download_shared_file", MCP_TOOL_NAMES)
        self.assertIn("upload_shared_file", MCP_TOOL_NAMES)
        self.assertIn("delete_shared_file", MCP_TOOL_NAMES)
        self.assertIn("update_shared_file_position", MCP_TOOL_NAMES)
        ...
        self.assertIn("download_repair_order_print_pdf", MCP_TOOL_NAMES)
        self.assertIn("create_document_without_card_pdf", MCP_TOOL_NAMES)
