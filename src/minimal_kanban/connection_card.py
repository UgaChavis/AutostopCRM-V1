...
def build_chatgpt_connector_payload(settings: IntegrationSettings) -> str:
    payload = {
        ...
        "notes": [
            ...
            "For vehicle cards, call get_board_snapshot first when you need a quick board-wide fallback, or get_board_content when broad context or recent history matters; use get_gpt_wall when you need both hidden machine wall sections in one response.",
