...
<ol class="doc-terms__list">
  ...
  <li><strong>Хранение автомобиля:</strong> после уведомления о готовности первые 2 дня хранения бесплатные, далее стоимость хранения составляет 150 рублей в сутки.</li>
  <li><strong>Выдача автомобиля:</strong> автомобиль выдается только после полной оплаты выполненных работ и использованных материалов.</li>
  <li><strong>Фотофиксация:</strong> претензии по повреждениям кузова принимаются только если фотофиксация состояния автомобиля проведена при сдаче машины совместно с представителем сервиса. Если фотофиксация не проводилась, претензии по повреждениям после выезда автомобиля из сервиса не принимаются.</li>
  <li><strong>Сопутствующие работы:</strong> работы и сопутствующие действия стоимостью до 5000 рублей могут выполняться без отдельного согласования, если они необходимы для продолжения ремонта.</li>
</ol>
        """
    ).strip()
