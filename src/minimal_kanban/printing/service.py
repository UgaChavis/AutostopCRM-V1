...
<ol class="doc-terms__list">
  <li><strong>Гарантия сервиса:</strong> автосервис несет гарантию только за качество выполненных работ и новые оригинальные запасные части, установленные сервисом.</li>
  <li><strong>30 дней:</strong> гарантия на выполненные работы и новые оригинальные запасные части. На запасные части, предоставленные заказчиком, гарантия не распространяется.</li>
  <li><strong>АКПП:</strong> при ремонте автоматической коробки передач восстанавливается только ее механическая часть. Коробка собирается на родном блоке управления (гидроблоке), и качество результата зависит в том числе от состояния этого блока. Если после ремонта выясняется, что блок управления КПП неисправен, расходы на его ремонт или замену несет заказчик.</li>
...
<ol class="doc-terms__list doc-terms__list--compact">
  ...
  <li><strong>АКПП:</strong> при ремонте коробки передач восстанавливается только механическая часть; состояние гидроблока и блока управления влияет на результат ремонта.</li>
