...
from .web_completion_act import PRINTING_COMPLETION_ACT_SCRIPT
from .web_styles import PRINTING_WEB_MODULE_STYLE as PRINTING_WEB_MODULE_STYLE
from .web_template_editor import (
...
"""
    + PRINTING_TEMPLATE_EDITOR_HELPERS_SCRIPT
    + r"""    function repairOrderPrintSelectedIds() {
...
"""
    + PRINTING_TEMPLATE_EDITOR_WORKFLOW_SCRIPT
    + r"""    function handleRepairOrderPrintModalOverlayClick(event) {
...
PRINTING_WEB_MODULE_SCRIPT = (
    ...
    + PRINTING_COMPLETION_ACT_SCRIPT
    + _PRINTING_SCRIPT_PART3
)
