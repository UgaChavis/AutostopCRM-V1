...
def build_service_routes(
    ...
    *,
    ...
    return {
        ...
        "/api/preview_repair_order_reopen": service.preview_repair_order_reopen,
        "/api/get_repair_order_cycles": service.get_repair_order_cycles,
        "/api/reopen_repair_order": service.reopen_repair_order,
        ...
        "/api/get_completion_act_form": service.get_completion_act_form,
        "/api/save_completion_act_form": service.save_completion_act_form,
        "/api/reset_completion_act_form": service.reset_completion_act_form,
        ...
        "/api/start_card_timer": service.start_card_timer,
        "/api/stop_card_timer": service.stop_card_timer,
